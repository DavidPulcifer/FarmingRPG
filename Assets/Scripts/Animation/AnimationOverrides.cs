...
public class AnimationOverrides : MonoBehaviour
{
    ...
    [SerializeField] SO_AnimationType[] soAnimationTypeArray = null;

    Dictionary<AnimationClip, SO_AnimationType> animationTypeDictionaryByAnimation;
    Dictionary<string, SO_AnimationType> animationTypeDictionaryByCompositeAttributeKey;
